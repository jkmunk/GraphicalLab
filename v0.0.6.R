  ...
  if (!((is.na(analyses[Alistrow,
    ...
    for (i in 1:length(tempraw)) {
      ...
      if (grepl(">",
        ...
        ltgtnames[counter] <- names(tempraw)[i]
        
        # put value in ltgt
        ltgt[counter] <- as.numeric(str_replace(substr(tempraw[1,
                                                               i],
                                                       3,
                                                       nchar(tempraw[1,
                                                                     i])),
...
#    print(Data[d,1])
    ...
    for (i in 1:length(tempraw)) {
      ...
      # or if data point is not missing, nor NA,
        ...
        tempraw3[counterB] <- as.numeric(str_replace(tempraw[1,
                                                 i],
                                                 ",",
                                                 "."))
    ...
    ltgt <- as.data.frame(cbind(as.numeric(ltgtnames),
                                as.numeric(as.character(str_replace(ltgt, ",", "."))),
                                extreme),
